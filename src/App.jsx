...
const PRE_CACHED = {
  ...
  "parle-g_weight_loss": { product_name:"Parle-G", brand:"Parle", category:"Biscuit", health_score:25, nutriscore_grade:"D", health_star_rating:1.5, verdict:"High sugar and refined flour — avoid for weight loss goals.", goal_compatibility:"High glycemic index causes insulin spikes and hunger. Counterproductive for weight loss. Swap for roasted chana.", diet_flag:null, region_note:"Try ragi biscuits instead — similar price, much better for weight management.", nutrients:{ calories_per_100g:450, protein_g:6.7, carbs_g:76, sugar_g:22, fat_g:12, saturated_fat_g:5.5, sodium_mg:180, fibre_g:0.5 }, red_flags:["High glycemic index","Low satiety","Empty calories"], green_flags:["Portion controllable","Inexpensive"], healthier_alternatives:["Roasted chana","Fox nuts (makhana)","Ragi biscuits"], tip:"Replace with roasted chana — same cost, 3x more protein, keeps you full longer." },
  "parle-g_muscle_gain": { product_name:"Parle-G", brand:"Parle", category:"Biscuit", health_score:30, nutriscore_grade:"D", health_star_rating:1.5, verdict:"Too low in protein to support muscle gain. Quick energy snack only.", goal_compatibility:"Only 6.7g protein per 100g with high carbs and sugar. Not useful for muscle building.", diet_flag:null, region_note:"Pair with peanut butter for a better post-workout snack.", nutrients:{ calories_per_100g:450, protein_g:6.7, carbs_g:76, sugar_g:22, fat_g:12, saturated_fat_g:5.5, sodium_mg:180, fibre_g:0.5 }, red_flags:["Very low protein","High sugar","Low muscle-building value"], green_flags:["Quick energy before workout","Affordable"], healthier_alternatives:["Peanut butter on whole wheat","Boiled eggs","Roasted chana"], tip:"Eat 2 Parle-G with peanut butter before a workout for quick energy plus protein." },
  "parle-g_heart_health": { product_name:"Parle-G", brand:"Parle", category:"Biscuit", health_score:28, nutriscore_grade:"D", health_star_rating:1.5, verdict:"Refined flour, sugar and saturated fat — not ideal for heart health.", goal_compatibility:"Regular consumption raises blood sugar and LDL cholesterol. Occasional treat only.", diet_flag:null, region_note:"Switch to oat-based biscuits for a heart-friendlier option.", nutrients:{ calories_per_100g:450, protein_g:6.7, carbs_g:76, sugar_g:22, fat_g:12, saturated_fat_g:5.5, sodium_mg:180, fibre_g:0.5 }, red_flags:["Raises LDL cholesterol","High sugar","Saturated fat"], green_flags:["Small portions manageable","Low sodium"], healthier_alternatives:["Oat biscuits","Digestive biscuits","Whole wheat crackers"], tip:"Limit to 1-2 biscuits max. Choose digestive biscuits instead for daily snacking." },
  "parle-g_diabetes": { product_name:"Parle-G", brand:"Parle", category:"Biscuit", health_score:15, nutriscore_grade:"D", health_star_rating:1, verdict:"High glycemic index — dangerous for diabetics. Avoid completely.", goal_compatibility:"22g sugar per 100g causes rapid blood sugar spikes. Strictly avoid for diabetes management.", diet_flag:null, region_note:"Ask your doctor about specific sugar-free biscuit alternatives available in India.", nutrients:{ calories_per_100g:450, protein_g:6.7, carbs_g:76, sugar_g:22, fat_g:12, saturated_fat_g:5.5, sodium_mg:180, fibre_g:0.5 }, red_flags:["Very high sugar","High glycemic index","Dangerous for diabetics"], green_flags:["Small pack sizes help limit intake"], healthier_alternatives:["Sugar-free digestive biscuits","Roasted chana","Cucumber slices"], tip:"Avoid completely. If craving something crunchy, try roasted chana or fox nuts instead." },
  "parle-g_kids": { product_name:"Parle-G", brand:"Parle", category:"Biscuit", health_score:42, nutriscore_grade:"D", health_star_rating:2, verdict:"A childhood staple but high in sugar. Fine occasionally — not as a daily school snack.", goal_compatibility:"Better options exist for growing children. High sugar affects concentration and energy levels.", diet_flag:null, region_note:"A beloved snack across India — fine for occasional treats but not daily nutrition.", nutrients:{ calories_per_100g:450, protein_g:6.7, carbs_g:76, sugar_g:22, fat_g:12, saturated_fat_g:5.5, sodium_mg:180, fibre_g:0.5 }, red_flags:["High sugar for children","Low nutritional value","Causes energy crashes"], green_flags:["Kids love the taste","Affordable","Vitamin fortified"], healthier_alternatives:["Ragi biscuits","Fruit slices","Roasted makhana"], tip:"Give as an occasional treat — not a daily school snack. Pair with milk for better nutrition." },
  "maggi noodles_weight_loss": { product_name:"Maggi Noodles", brand:"Nestlé", category:"Instant Noodles", health_score:18, nutriscore_grade:"D", health_star_rating:1, verdict:"High sodium and refined carbs — avoid completely for weight loss.", goal_compatibility:"Empty calories with very high sodium. Causes water retention and hunger within hours.", diet_flag:null, region_note:"Replace with homemade poha or upma — similar comfort, much better nutrition.", nutrients:{ calories_per_100g:430, protein_g:9.5, carbs_g:68, sugar_g:2, fat_g:12, saturated_fat_g:5, sodium_mg:950, fibre_g:2 }, red_flags:["Very high sodium causes bloating","Refined carbs","Low satiety"], green_flags:["Quick to make"], healthier_alternatives:["Poha","Oats upma","Daliya"], tip:"Make poha instead — 15 minutes, half the calories, 3x more filling." },
  "amul butter_weight_loss": { product_name:"Amul Butter", brand:"Amul", category:"Dairy", health_score:30, nutriscore_grade:"C", health_star_rating:2, verdict:"Very calorie dense — use sparingly or avoid for weight loss.", goal_compatibility:"720 calories per 100g makes this easy to overconsume. Strict portion control needed.", diet_flag:null, region_note:"Switch to cold-pressed ghee in smaller quantities — more flavour, similar calories.", nutrients:{ calories_per_100g:720, protein_g:0.5, carbs_g:0, sugar_g:0, fat_g:80, saturated_fat_g:50, sodium_mg:600, fibre_g:0 }, red_flags:["Very calorie dense","Easy to overconsume","High saturated fat"], green_flags:["No carbs or sugar","Natural product"], healthier_alternatives:["Homemade curd spread","Hummus","Avocado"], tip:"Maximum 5g per day. Measure with a knife — never spread directly from the pack." },
};
